document.addEventListener('DOMContentLoaded', function() {
    ...
    var voteForms = document.querySelectorAll<HTMLFormElement>('.vote-form');
    ...
    voteForms.forEach(function(form) {
        form.addEventListener('submit', function(event: Event) {
            ...
            var idInput = form.querySelector<HTMLInputElement>('input[name="id"]');
            if (!idInput) {
                return;
            }
            ...
            var submitButton = form.querySelector<HTMLButtonElement>('button');
            if (submitButton) {
